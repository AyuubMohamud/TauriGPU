...
@cocotb.test()
async def test_fp_max_1(dut):
    """Test for floating-point max: max(1.0, 2.0)"""
    ...
    dut.opcode.value = 0b0001  # Max operation
    ...
    assert dut.result.value == expected_result, f"Error (fp max): {dut.result.value} != {expected_result}"


@cocotb.test()
async def test_fp_max_2(dut):
    """Test for floating-point max: max(0.5, 0.5)"""
...
@cocotb.test()
async def test_fp_max_3(dut):
    """Test for floating-point max: max(-1.0, 1.0)"""
...
@cocotb.test()
async def test_fp_max_4(dut):
    """Test for floating-point max: max(3.5, -2.5)"""
    ...
    expected_result = 0x406000  # Expected result: 3.5 in IEEE 754 format
    assert dut.result.value == expected_result, f"Error (fp max): {dut.result.value} != {expected_result}"
